...
* `Tool.schema` is now typed as `z.ZodType<I>` instead of `z.ZodType<I, z.ZodTypeDef, unknown>`. The third type parameter slot was removed in zod 4 — `ZodType` is now `ZodType<Output, Input, Internals>`, not `ZodType<Output, Def, Input>`. Consumers that author tools using `z.object()`/`z.string()`/`z.infer<>` are unaffected; only consumers that explicitly typed `Tool.schema` with the legacy 3-arg form need to update.
...
* add terminal tty builtins ([#102](https://github.com/ambiently-work/faux/issues/102)) ([a331212](https://github.com/ambiently-work/faux/commit/a331212e9b0c77111a926879e999c3c5d64e9518))
* add time and timeout builtins ([#101](https://github.com/ambiently-work/faux/issues/101)) ([55d368a](https://github.com/ambiently-work/faux/commit/55d368adde0f8651773a90aba6578a535f2caa5c))
...
* bump zod to v4 ([#93](https://github.com/ambiently-work/faux/issues/93)) ([8e05c8c](https://github.com/ambiently-work/faux/commit/8e05c8c23f5229342d158811c27e40acc7da3f89))
...
* **deps:** update dependency astro to v6 [security] ([#99](https://github.com/ambiently-work/faux/issues/99)) ([e571d5f](https://github.com/ambiently-work/faux/commit/e571d5f02076c75ea5f4443d12a8476861fa00aa))
...
* undo unintended 1.0.0 release ([#79](https://github.com/ambiently-work/faux/issues/79)) ([8f05b53](https://github.com/ambiently-work/faux/commit/8f05b53434f2fc8e6fedd71ff6f04132fc0d1802))
